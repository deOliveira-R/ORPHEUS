...
2. **Heterogeneous spatial operator** (MMS) — verified in
   :mod:`orpheus.derivations.continuous.mms.sn` with a manufactured solution on
...
from ...common.eigenvalue import kinf_homogeneous
...
from ...common.xs_library import get_mixture, get_xs
...
def all_cases() -> list[VerificationCase]:
    ...
    :mod:`orpheus.derivations.continuous.mms.sn` (spatial operator) and
...
def _xs_1g_dict(mixture) -> dict:
    ...
    :func:`orpheus.derivations.common.xs_library.get_mixture` or built
...
def derive_sn_heterogeneous_continuous(
    ...
    mat_A_name, mat_B_name : str
        Names in the :mod:`orpheus.derivations.common.xs_library` library.
