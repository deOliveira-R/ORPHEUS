...
:func:`~orpheus.derivations.continuous.peierls_nystrom.sphere._build_peierls_sphere_case`
and
...
:data:`~orpheus.derivations.continuous.peierls_nystrom.sphere.GEOMETRY` singleton
binding the canonical
:data:`~orpheus.derivations.continuous.peierls_nystrom.geometry.SPHERE_1D`. The
...
the unified structure and :doc:`/theory/methods/collision_probability` for
