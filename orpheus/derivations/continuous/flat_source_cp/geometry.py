...
:mod:`~orpheus.derivations.continuous.flat_source_cp.slab`, :mod:`~.cp_cylinder`,
:mod:`~.cp_sphere`.
"""
...
from ...common.kernels import chord_half_lengths, e3_vec, ki_n_mp
from ...common.quadrature_recipes import chord_quadrature
