...
* :mod:`.origins` — Branch-1 SymPy: closed-form derivations of the
  ...
  tests at ``tests/derivations/test_carlvik_galerkin_symbolic.py``.
...
* :mod:`.slab` — Branch-2 production: :func:`.slab.solve_carlvik_galerkin_slab`
  for bare-critical multiplying slabs with linearly anisotropic
  scattering. Reproduces Dahl-Sjostrand Table II.
* :mod:`.sphere` — Branch-2 production: :func:`.sphere.solve_carlvik_galerkin_sphere`
