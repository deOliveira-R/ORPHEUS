...
class PartialCurrentOperator(LinearOperator):
    ...
    :meth:`AngularAverageOperator.apply` (and there already divided by the
...
class IsotropicEmissionOperator(LinearOperator):
    ...
    **The normalisation belongs HERE, not in the contraction**, and that is
    ...
    composite conservative — see :class:`AngularAverageOperator` for the
    measured discussion of that choice and of the tangential-band hazard it
    dissolved at B3.4a.
