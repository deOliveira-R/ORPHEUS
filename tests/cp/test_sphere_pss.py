...
_SPHERE_PSS_RULES = [
    "tests/derivations/test_peierls_greens_function_symbolic.py::test_v_alpha2_Pss_matches_hebert_via_polar_path",
    "tests/derivations/test_quadrature.py::test_chord_quadrature_recovers_constant_integral",
    "tests/derivations/test_quadrature.py::test_chord_quadrature_homogeneous_panel_structure",
]
...
@pytest.mark.rests_on(
    "tests/cp/test_sphere_pss.py::test_homogeneous_pss_matches_the_closed_form",
)
@pytest.mark.parametrize("R", [1.0, 2.5])
...
@pytest.mark.rests_on(
    "tests/cp/test_sphere_pss.py::test_homogeneous_pss_matches_the_closed_form",
    "tests/derivations/test_quadrature.py::test_chord_quadrature_multi_region_panel_structure",
)
