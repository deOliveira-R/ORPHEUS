...
from tests.numerics.test_default_iteration_budget import _MEASURED_D3_ABSORBER
...
@pytest.mark.rests_on(
    "tests/numerics/test_default_iteration_budget.py::TestTheBudgetTracksItsTolerance::test_it_covers_the_configuration_that_opened_the_issue",
    "tests/sn/solve/test_convergence_contract.py::TestEveryEntryDerivesItsBudget::test_the_solver_resolves_none_to_the_derived_budget",
    "tests/sn/solve/test_d3_admission.py::test_d3_pure_absorber_per_ordinate_psi_exact",
)
def test_the_derived_budget_converges_the_case_that_opened_340() -> None:
    ...
    * a stale ``_MEASURED_D3_ABSORBER`` table in
      ``tests/numerics/test_default_iteration_budget.py``.  That table is a
    ...
    assert needed == tabled, (
        ...
        f"tests/numerics/test_default_iteration_budget.py records {tabled}.  "
