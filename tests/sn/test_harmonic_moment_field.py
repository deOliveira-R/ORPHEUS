...
class TestHarmonicMomentFieldScalarFlux:
    ...
    def test_scalar_flux_agrees_with_integrate_angular(self) -> None:
        ...
        """
        from orpheus.sn.scattering import HarmonicMomentProjection
        m = _slab_mesh()
        L = 1
...
class TestRLambdaMRoundTrip:
    def test_aniso_part_zero_under_isotropic_psi(self) -> None:
        ...
        a :class:`PerOrdinateSource` matching that algebraic claim.
        """
        ...
        # Must be PerOrdinateSource (not bare ndarray) under typed-in.
        assert isinstance(out, PerOrdinateSource)
