...
``tests/gates/sn/verification/analytical/test_kinf_homogeneous.py`` and
``tests/gates/sn/operators/test_streaming_collision_operator.py`` (the
...
#   tests/gates/sn/operators/test_streaming_collision_operator.py::
