...
RE-KEY of ``tests/gates/test_layer_imports.py``'s fresh-interpreter list, not rows
...
from tests.gates.numerics import NUMERICS_DATA

ORPHEUS_ROOT = pathlib.Path(__file__).resolve().parents[3]
...
# ===========================================================================
# Group A — the import graph  (-> tests/gates/test_layer_imports.py)
# ===========================================================================
...
# ===========================================================================
# Group B — ONE closure  (-> tests/gates/numerics/test_invariance.py)
# ===========================================================================
...
# ===========================================================================
# Group C — the deleted step 2  (-> tests/gates/numerics/test_invariance.py)
# ===========================================================================
...
class TestR2OrdinatePermutationIsUnchanged:
    ...
    -> ``tests/gates/numerics/test_quadrature_directional.py``.  The reference is a table
    FROZEN at HEAD before the carve (``tests/gates/numerics/data/r2_perm_baseline.npz``, `[M]` 45
...
class TestR2SelectionIsUnchanged:
    ...
    -> ``tests/gates/numerics/test_registry.py``.  ``AngularSymmetry.admits_symmetry``
    ...
    wording is pinned once in ``tests/gates/numerics/test_registry.py`` (see
    ``stage_of``).

    The reference is a table FROZEN at HEAD before the carve
    (``tests/gates/numerics/data/r2_selection_baseline.json``, `[M]` 48 (geometry x degree)
    verdicts, all
    48 selecting).
    """
