...
* Diamond Difference's L1 transport accuracy is verified
  ...
  ``tests/gates/sn/l1_analytical/`` and the bit-identical regression
  snapshot tests at ``tests/gates/sn/regression/`` — Round 2 does not
...
from tests.gates.sn.sweep.core._c_surrogate import (
    c_from_constants,
