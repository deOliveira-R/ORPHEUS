...
``tests/gates/sn/sweep/core/test_cache.py``) and, per-cell, at the MATVEC's own
...
from tests.gates.sn._test_helpers import het_operands, placeholder_materials, sweep_once
