...
unstable on this venv)::
    ...
    .venv/bin/python -O -m pytest \
      tests/gates/sn/architecture/test_composition_cost.py -q -p no:cacheprovider
...
from tests.gates.sn.architecture._config import (
...
def _cart2d(nx: int, ny: int, *, ng: int = 2, sn_order: int = 4) -> SNProblem:
    ...
    Shaped after ``tests/gates/sn/operators/test_removal_form_matvec_sweep.py``'s
