...
`tests/gates/sn/test_scattering_operator.py::TestPreT3RegressionSnapshot`
and `tests/gates/sn/test_material_xs_field.py::TestApplyLegendreScatteringMoments`.

Per the T.3 verification spec
(`.claude/agent-memory/test-architect/wave_t_t3_scattering_verification_spec.md`)
§4 substep T.3a: "Snapshot file exists; tests/gates/sn/_fixtures/wave_t_t3/
...
-----
    ...
    .venv/bin/python tests/gates/sn/_fixtures/wave_t_t3/_capture_pre_t3_snapshots.py
...
# (mirrors `solver_2g_p1_n2n` at tests/gates/sn/test_scattering_operator.py:604)
# ─────────────────────────────────────────────────────────────────────
