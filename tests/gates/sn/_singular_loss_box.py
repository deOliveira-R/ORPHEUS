...
:mod:`tests.gates.sn.operators.test_loss_nullspace_reflective_box` (facts about
:math:`\ker A` itself) and
:mod:`tests.gates.sn.solve.test_boundary_gs_is_a_coherent_splitting` (facts about the
