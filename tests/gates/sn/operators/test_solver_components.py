...
eigenvalue solves moved to ``tests/gates/sn/eigenvalue/test_keff_2d.py``.
...
from tests.gates.sn._independent_dd_sweep import (
    hand_sweep,
    snapshot_source,
    solver_2g_case,
...
def solver_2g():
    ...
    The case is :func:`tests.gates.sn._independent_dd_sweep.solver_2g_case`, the
...
class TestTransportSweep:
    ...
    @pytest.mark.rests_on(
        "tests/gates/sn/operators/test_solver_components.py::TestTransportSweep::test_matches_independent_hand_sweep",
    )
    def test_matches_saved_reference(self, solver_2g):
        ...
        ``.venv/bin/python -O -c "from tests.gates.sn._independent_dd_sweep import
    ...
    @pytest.mark.rests_on(
        "tests/gates/numerics/test_rules_sphere.py::test_lebedev_weight_sum_is_4pi",
        "tests/gates/numerics/test_rules_sphere.py::test_lebedev_integrates_constants",
    )
    def test_matches_independent_hand_sweep(self, solver_2g):
        ...
        with :func:`tests.gates.sn._independent_dd_sweep.hand_sweep`, a plain-loop
        ...
        in :func:`~tests.gates.sn._independent_dd_sweep.sweep_agreement_tolerances`).
