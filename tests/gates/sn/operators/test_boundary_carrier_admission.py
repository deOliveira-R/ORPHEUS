...
from tests.gates.sn.architecture.test_monomorphic_leaves import (
    _cart2d,
    _cylinder,
    _random_composite,
    _slab,
...
def test_g3_2b_a_content_mismatch_is_refused_by_the_content_clause_alone():
    ...
    """
    from tests.gates.sn.operators.test_space_content_witnesses import _composite, _slab as _slab_of_width
...
def test_g3_4_the_carrier_parse_has_one_body_and_five_call_sites():
    ...
    root = pathlib.Path(__file__).resolve().parents[4] / "orpheus"
