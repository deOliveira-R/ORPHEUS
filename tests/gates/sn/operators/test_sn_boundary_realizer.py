...
from tests.gates.sn._test_helpers import face_method_space, face_trace
...
class TestRealizeWhite:
    ...
    **B3.4a** to :math:`\Gamma_+ \to \Gamma_-`.
    ...
    :func:`~tests.gates.sn._test_helpers.face_method_space`, whose face must MATCH
    ...
    ``tests/gates/sn/operators/test_angular_average_operator.py``; these legs pin
    ...
    def test_white_partial_albedo_matches_albedo_times_angular_average(self):
        ...
        ``tests/gates/sn/operators/test_angular_average_operator.py``).
...
class TestRealizeAlbedo:
    ...
    **RE-POSED at campaign phase B3.4b.** These rows asserted the pre-B3.4b
    ...
    Division of labour with ``tests/gates/geometry/test_reemission_closure.py``
    ---------------------------------------------------------------------------
