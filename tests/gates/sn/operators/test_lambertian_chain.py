...
This module carries the claims of ``tests/gates/sn/operators/test_angular_average_operator.py``
...
``tests/gates/sn/operators/test_lambertian_factored.py`` already gates — the
