...
was retired 2026-06-04; see ``tests/gates/sn/solve/test_fixed_source_2d_equivalence.py``).
...
``tests/gates/sn/sweep/cartesian_2d/test_2d_l2_matvec_correctness.py::test_solve_sn_2d_krylov_homogeneous_reflective_recovers_kinf``;
...
2-D vacuum bulk snapshot under ``tests/gates/sn/_data/bc_extraction_2d_baseline/``
