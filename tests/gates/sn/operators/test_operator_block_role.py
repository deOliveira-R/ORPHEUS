...
pinned in ``tests/gates/numerics/test_operator_protocols.py``; here we pin the
SN tagging itself.
...
from tests.gates.sn._test_helpers import face_method_space, placeholder_materials
