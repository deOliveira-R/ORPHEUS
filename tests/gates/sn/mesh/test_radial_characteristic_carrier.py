...
* **A2 (flat round-trip incl. the seed tail)** — the 3-block layout is
  ...
  (``tests/gates/transport/test_composite.py``) and the COUPLED round trip +
...
* **A3 (algebra closure threading the seed; the mixed-presence law; the
  ...
  ``tests/gates/transport/test_radial_characteristic_field.py``; the
...
from tests.gates.sn._test_helpers import cart2d_2g_nonsquare, placeholder_materials
