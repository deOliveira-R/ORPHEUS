...
``tests/gates/sn/regression/`` is the canonical snapshot + generator store
...
change" PR is::
    ...
    pytest tests/gates/sn/regression/ -W error::tests.gates.sn.regression._regression_assert.DriftWarning
...
from tests.gates.sn.regression._regression_assert import DriftWarning
...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "filterwarnings", "always::tests.gates.sn.regression._regression_assert.DriftWarning"
    )
