...
Run:  ``.venv/bin/python -m tests.gates.sn.regression._generate_walk_baselines``
"""
...
from tests.gates.sn.operators.test_g_adjoint_reciprocity import (
    _make_cyl,
    _make_cyl_product,
    _make_slab,
    _make_sphere,
...
from tests.gates.sn.regression._generate_snapshots import SNAPSHOT_DIR
...
def _draw_with_seed(sn, rng):
    ...
    fill (see :func:`~tests.gates.sn._test_helpers.random_radial_characteristic_field`)."""
