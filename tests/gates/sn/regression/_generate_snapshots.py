...
Run::
    ...
    python -m tests.gates.sn.regression._generate_snapshots
    python -m tests.gates.sn.regression._generate_snapshots --case slab_2g_homogeneous_dd_n20
...
def _cartesian_2d_het_si(ng: str) -> dict:
    ...
    on this configuration by ``tests/gates/sn/eigenvalue/test_keff_2d.py::
