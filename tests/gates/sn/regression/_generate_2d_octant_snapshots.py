...
Run::
    ...
    python -m tests.gates.sn.regression._generate_2d_octant_snapshots --case 03_l7_trap_mixedBC_2g_het_LS4
    python -m tests.gates.sn.regression._generate_2d_octant_snapshots --list
...
companion test at
:file:`tests/gates/sn/sweep/cartesian_2d/test_2d_octant_sweep_equivalence.py`
...
Parity with :mod:`tests.gates.sn.regression._generate_snapshots`:
...
from tests.gates.sn.sweep.cartesian_2d.test_2d_octant_sweep_equivalence import (
    CASES,
    SNAPSHOT_DIR,
