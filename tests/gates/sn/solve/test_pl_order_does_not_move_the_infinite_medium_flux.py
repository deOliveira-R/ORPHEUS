...
``tests/gates/sn/solve/test_pl_order…`` + ``tests/gates/numerics/{test_spherical_harmonic_basis,
...
``tests/gates/numerics/test_legendre_basis.py`` and ``tests/gates/numerics/test_descent.py``.
