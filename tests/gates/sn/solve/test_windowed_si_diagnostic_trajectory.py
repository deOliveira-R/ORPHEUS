...
that diagnostic, ``tests/gates/numerics/test_si_diagnostic_trajectory.py``, REFUSES a
...
``tests/gates/transport/frames/test_moment_metric_fork_premise.py``.
...
from tests.gates.sn.architecture.test_monomorphic_leaves import _two_region_fissile
