...
class TestRank2SlabKEffKInfConvergence:
    ...
    def test_solve_peierls_1g_boundary_white_rank2_end_to_end(self):
        ...
        from orpheus.derivations.continuous.peierls_nystrom.geometry import solve_peierls_1g
    ...
    def test_rank_n_white_closure_raises_pending_normalisation(self):
        ...
        """
        from orpheus.derivations.continuous.peierls_nystrom.geometry import CurvilinearGeometry
...
class TestSlabPolarVsCyl1DOpticallyThick:
    ...
    @pytest.mark.rests_on(
        "tests/gates/derivations/test_peierls_rank2_bc.py::TestSlabPolarVsNativeE1KEff::test_1g_vacuum_slab_k_eff_matches_native",
        "tests/gates/derivations/test_peierls_reference.py::TestCylinderKernelRowSum::test_row_sum_matches_analytical_uniform_source",
        "tests/gates/derivations/test_peierls_geometry.py::TestRhoInnerIntersectionsHollow",
    )
