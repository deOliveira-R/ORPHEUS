...
def test_class_b_sphere_hebert_chi_dependence(chi_spectrum,
    ...
    assert abs(actual_err_pct - expected_err_pct) < tol_pct, (
        ...
        f"docs/theory/references/peierls_nystrom.rst §peierls-class-b-sphere-hebert. "
...
def test_class_b_hebert_raises_for_slab():
    ...
    from orpheus.derivations.continuous.peierls_nystrom.geometry import SLAB_POLAR_1D
    pytest.skip(
