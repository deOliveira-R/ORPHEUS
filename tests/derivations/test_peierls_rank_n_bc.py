...
``docs/theory/references/peierls_nystrom.rst``). For tests that also stress the
...
def test_shifted_legendre_orthonormality(n, m):
    ...
    from orpheus.derivations.continuous.peierls_nystrom.geometry import gl_float
...
def test_rank_n_angular_moment_exactness():
    ...
    """
    from orpheus.derivations.continuous.peierls_nystrom.geometry import (  # type: ignore[attr-defined]
