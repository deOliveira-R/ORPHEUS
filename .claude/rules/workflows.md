<!-- GENERATED by tools/docs/generate_harness.py from docs/development/rules/workflows.md — DO NOT EDIT. Edit the source page; `python -m tools.docs.generate_harness` (or any Sphinx build) rewrites this file. -->
