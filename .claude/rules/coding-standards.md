...
A name is chosen for the signal it carries about the structure it names, and the agent judges it (`[R]` the user, 2026-06-23: "as long as it carries a strong signal"). Founding cases: [the evidence page](../../docs/development/evidence/coding-standards.md#2026-06-22-naming-rulings).
