<!-- GENERATED by tools/harness from docs/development/rules/instrument-doctrine.md — DO NOT EDIT. Edit the source page; `python -m tools.harness` (or any Sphinx build) rewrites this file. -->
