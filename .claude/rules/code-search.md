<!-- GENERATED by tools/harness from docs/development/rules/code-search.md — DO NOT EDIT. Edit the source page; `python -m tools.harness` (or any Sphinx build) rewrites this file. -->
...
([the harness page](../../docs/development/harness.md), "The one-way flow"); its tool list is
the `nexus-guide` skill. This page holds what is ORPHEUS's: its cases, its
agents, its shell. Founding cases: [the evidence page](../../docs/development/evidence/code-search.md).
...
- The kinds of reference grep misses are enumerated with their instruments
  ...
  ([case](../../docs/development/evidence/code-search.md#2026-04-restructuring-grep-misses)).
...
`([^a-z_])Gram` return 1
([case](../../docs/development/evidence/code-search.md#2026-08-26-the-ugrep-fixture)). This is
...
- check: use `\b…\b`, or `-P` with a lookbehind, or drop the anchor; never put
  ...
  such reads ([case](../../docs/development/evidence/code-search.md#2026-09-17-git-grep-has-no-word-boundary)).
...
- **The standalone `Grep` and `Glob` tools are gone**, so text search is
  ...
  ([case](../../docs/development/evidence/code-search.md#2026-06-14-the-removed-grep-and-glob-tools)).
- **A sub-agent has no `ToolSearch`**
  ([case](../../docs/development/evidence/code-search.md#2026-08-19-a-sub-agent-has-no-toolsearch)):
...
- **A worktree's graph** ([L22](../../docs/development/evidence/lessons.md#l22-worktree-not-main))
  and **the briefing's silence**
  ([case](../../docs/development/evidence/code-search.md#2026-08-16-the-briefings-silence)): the
