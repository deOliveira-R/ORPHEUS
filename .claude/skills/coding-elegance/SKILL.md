...
---
<!-- GENERATED by tools/docs/generate_harness.py from docs/development/skills/coding-elegance.md — DO NOT EDIT. Edit the source page; `python -m tools.docs.generate_harness` (or any Sphinx build) rewrites this file. -->
...
[evidence page](../../../docs/development/evidence/coding-elegance.md), with its
[examples 1-5](../../../docs/development/evidence/coding-elegance.md#example-1-four-operator-unification);
...
> unspellable.
> [why](../../../docs/development/evidence/coding-elegance.md#why-this-skill-exists);
> [the argument](../../../docs/development/evidence/coding-elegance.md#bug-prevention-argument).
...
[pointers](../../../docs/development/evidence/coding-elegance.md#pointers)).
...
[case](../../../docs/development/evidence/coding-elegance.md#pattern-1-dunder-algebra)
...
[case](../../../docs/development/evidence/coding-elegance.md#pattern-2-single-source)
...
[case](../../../docs/development/evidence/coding-elegance.md#pattern-3-named-intermediates)
...
[case](../../../docs/development/evidence/coding-elegance.md#pattern-5-primitive-not-product)
...
- **The check that guardrail owes** [REFUTED 2026-08-19: its own worked
  ...
  [history](../../../docs/development/evidence/coding-elegance.md#ap18-reversal-history)
...
construction.
[case](../../../docs/development/evidence/coding-elegance.md#pattern-7-definition-site)
...
2. **NEVER** procedural for-loops over a domain that has its own algebra —
   **instead** invoke the dunders. `psi = L.solve(q)` IS the math.
   [case](../../../docs/development/evidence/coding-elegance.md#ap2-procedural-loops)
3. **NEVER** thread a boolean flag through a call to switch behaviour —
   **instead** polymorphism / strategy / sum types. Four booleans = 16
   ...
   [case](../../../docs/development/evidence/coding-elegance.md#ap3-boolean-flags)
4. **NEVER** a stringly-typed dispatch parameter — **instead** a singleton, enum
   ...
   [case](../../../docs/development/evidence/coding-elegance.md#ap4-stringly-typed-dispatch)
5. **NEVER** reduce over an anonymous intermediate, period — **instead** name it.
   ...
   [case](../../../docs/development/evidence/coding-elegance.md#ap5-anonymous-intermediate)
6. **NEVER** transcribe MATLAB/Fortran line-by-line — **instead** read the math
   the legacy claims to encode and write from the math.
   [case](../../../docs/development/evidence/coding-elegance.md#ap6-transcription)
...
9. **NEVER** write code you would have to comment to explain to a domain expert —
   **instead** name in the domain's vocabulary and let the code be the comment.
   ...
   [case](../../../docs/development/evidence/coding-elegance.md#ap9-explanatory-comments)
10. **NEVER** more abstraction than you have concrete instances to justify —
    **instead** wait for the second, then extract.
    [case](../../../docs/development/evidence/coding-elegance.md#ap10-premature-abstraction)
11. **NEVER** mark code "temporary" without a removal trigger — **instead**
    ...
    [case](../../../docs/development/evidence/coding-elegance.md#ap11-untracked-temporary)
12. **NEVER** ship code that "works but is ugly" alongside intent to clean it up
    later — **instead** clean before merging.
    [case](../../../docs/development/evidence/coding-elegance.md#ap12-ugly-shipped)
13. **NEVER** pass `numpy.ndarray` across a module boundary with shape and
    ...
    **Densest single cluster: 13 evidenced bugs** (ERR-002, 009, 011, 022, 031,
    ...
    [case](../../../docs/development/evidence/coding-elegance.md#ap13-bare-numpy)
14. **NEVER** hardcode a numerical constant derivable from a typed object in
    ...
    [case](../../../docs/development/evidence/coding-elegance.md#ap14-hardcoded-constants)
15. **NEVER** ship a specialised method before the general one when the general
    ...
    [case](../../../docs/development/evidence/coding-elegance.md#ap15-specialised-first)
...
19. **NEVER** silence a type-checker red on a NEW symbol with `# type: ignore`
    ...
    [case](../../../docs/development/evidence/coding-elegance.md#ap19-type-ignore)
...
- **Cross-cutting concerns belong in the type system, not in coding
  ...
  [case](../../../docs/development/evidence/coding-elegance.md#cross-cutting-concerns-in-types)
- **Dimensional analysis is a free verification tool.** Units must agree on
  ...
  [case](../../../docs/development/evidence/coding-elegance.md#dimensional-analysis-free-verification)
- **Refactors extend forward, not to fit legacy.** An N+1 change reaches for the
  ...
  once. [case](../../../docs/development/evidence/coding-elegance.md#refactors-extend-forward)
- **An unused argument is dead weight iff the math layers it OUTWARD for every
  ...
  [case](../../../docs/development/evidence/coding-elegance.md#unused-argument-dead-weight)
