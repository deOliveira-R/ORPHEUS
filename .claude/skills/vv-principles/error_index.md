...
**84 entries · 317 catching tests · 0 uncaught.**
...
Append a `.. error-entry:: ERR-085` block to `docs/theory/verification/error_catalog.rst` (next free id),
then tag its regression test `@pytest.mark.catches("ERR-085")`.
