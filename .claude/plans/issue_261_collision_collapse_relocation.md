...
> **Real home:** move to `.claude/plans/issue_261_collision_collapse_relocation.md` on the first execution
> turn (plan-mode restricts edits to the active plan file; the prior Frame-projection content lives at
> `.claude/plans/frame_projection_machinery.md`). Branch `refactor/operator-inverse-algebra`. Surgical,
