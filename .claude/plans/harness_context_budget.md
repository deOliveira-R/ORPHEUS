...
**[LANDED 0d376e4f, second pass in the next commit] T1 and T2 are DONE — the record is the section "T1 and T2 executed" and its "second pass" subsection at the end of this compaction point. The next step is T3: compact, then restart ON THE BRANCH `docs/development-substrate` (unmerged) and run T4.**
