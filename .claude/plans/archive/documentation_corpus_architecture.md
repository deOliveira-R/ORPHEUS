...
recorded inline. **Companion:** `.claude/plans/archive/sn_doc_architecture_231.md` (the in-flight
...
> Full page-cited harvests: `.claude/plans/archive/phase_i_survey_larsen_morel_2010.md` (M4b: ρ_SI = c
...
> `.claude/plans/archive/phase_i_survey_adams_larsen_2002.md` (M4b: the 5-step Fourier recipe §II.A;
