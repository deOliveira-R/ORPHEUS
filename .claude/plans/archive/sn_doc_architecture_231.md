...
> **`.claude/plans/archive/documentation_corpus_architecture.md`**. It is the layer ABOVE this plan
...
- 2026-07-14: **CORPUS PROPOSAL written** → `.claude/plans/archive/documentation_corpus_architecture.md`
...
**Read `.claude/plans/archive/documentation_corpus_architecture.md` — §7.1 (what Phase A landed) +
