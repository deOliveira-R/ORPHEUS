...
>
> **The B3.4 brief is §9.3 of `.claude/plans/archive/b3_domain_narrowing_crosswalk.md`** — read it
...
> **DESIGN OF RECORD: `.claude/plans/archive/b3_domain_narrowing_crosswalk.md`** — the
