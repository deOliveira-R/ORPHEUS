...
> split) is now **Phase A of `.claude/plans/archive/typed_carrier_grid_carve.md`**, where it
...
1. This plan (§1–§8).
2. `.claude/plans/archive/issue_226_b4_operator_generics_verification.md` — the test-architect
...
> taxonomy design `.claude/plans/archive/operator_machinery_taxonomy.md` (§12 phase order;
...
### Pointers
- **Verification spec (gate authority):** `.claude/plans/archive/issue_226_inverse_operator_verification.md`
...
Full inventory in `.claude/plans/archive/issue_226_b4_operator_generics_verification.md`. The
...
2. Open **`.claude/plans/archive/pyright_signal_cleanup.md`** → "### Resume here (next)". Mark
...
- **B4 verification plan:** `.claude/plans/archive/issue_226_b4_operator_generics_verification.md`.
- **Operator-generics design map:** `.claude/agent-memory/explorer/issue_226_operator_generics_map.md`.
- **Pyright burndown (exit target):** `.claude/plans/archive/pyright_signal_cleanup.md`.
