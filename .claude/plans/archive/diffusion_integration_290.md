...
2. **Checkpoint the durable plan** (`ORPHEUS/.claude/plans/archive/diffusion_integration_290.md`):
...
plan to `ORPHEUS/.claude/plans/archive/diffusion_integration_290.md` (durable home), create
...
- Diffusion's functional realizer is the second functional realizer — the recorded
  ...
  leaf dispatch. Execute per `.claude/plans/archive/realize_recursively_move_spec.md` **after L24
