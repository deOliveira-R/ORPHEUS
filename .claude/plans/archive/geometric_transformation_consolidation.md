...
> (`.claude/plans/archive/quadrature_machinery_campaign.md`) is the authority
...
`.claude/plans/archive/green_the_seven_quadrature_reds.md`. Verification criterion (1)
...
`.claude/plans/archive/green_the_seven_quadrature_reds.md`.
...
(`.claude/plans/archive/quadrature_machinery_campaign.md`) — never a summary.
