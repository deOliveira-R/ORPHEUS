...
> Implementation plan (companion to the verification spec `.claude/plans/archive/a3_solve_transpose_verification.md`).
> Branch `feature/sn-adjoint-transport`. Surgical, **main-agent-direct, user-steered, NO method-implementer**;
> per-gate cadence. Campaign home: `.claude/plans/archive/kiso_cross_model_extraction.md`. Phase spec:
> `.claude/plans/archive/adjoint_sn_transport.md:130`.
