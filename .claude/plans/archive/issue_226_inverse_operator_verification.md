...
**Sibling to** `.claude/plans/archive/issue_226_b4_operator_generics_verification.md` (the
...
carve itself is `.claude/plans/archive/operator_inverse_algebra_carve.md` (§3 target, §5
phases, §6 forks).
...
- **Phase 0/1 spec (LANDED net this extends):**
  `.claude/plans/archive/issue_226_b4_operator_generics_verification.md`.
- **The carve:** `.claude/plans/archive/operator_inverse_algebra_carve.md` (§3 target, §5
  phases, §6 forks).
