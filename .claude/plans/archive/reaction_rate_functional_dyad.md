...
> **Real home:** move to `.claude/plans/archive/reaction_rate_functional_dyad.md` on the first execution turn
> (plan-mode pinned this session to `reactive-moseying-cake.md`, which held a stale COMMITTED copy of the
> #261 plan — the live #261 record is `.claude/plans/archive/issue_261_collision_collapse_relocation.md`). Branch
