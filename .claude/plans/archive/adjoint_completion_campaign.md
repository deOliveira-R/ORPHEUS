...
`.claude/plans/archive/residue_verification_spec.md` (test-architect, 2026-07-23) — its
...
- **C5 CLOSED ✅ — MERGED to main (ff, `ef71e3b5..8abd3c6c`, 5 commits:
  ...
  `.claude/plans/archive/p6_adjoint_verification_spec.md:230-333` (the P1.2–P1.5
