...
- **Pre-existing dangling "Cardinal Rule 6"** ref in vv-principles/SKILL.md + error_catalog.md (CLAUDE.md has only Rules 1–5). Decide the correct target (the ≥2G / 1-group-degeneracy directive) or drop the citation.
