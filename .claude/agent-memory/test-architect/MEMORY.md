...
- **#434 R4 — the lift is a derivation output, an orbit space's dimension is a theorem** — ⏹ PLAN + GATES DELIVERED (`scratch/_r4_{verification_plan.md,gates_draft.py,test_migration.md}`; 102 rows / 31 functions, 17-arm battery, dry-run shim 100/102 in 0.91 s). ⚠⚠ the kernel is Mode-12 BLIND — `[M]` 0 of 9925. → **`L73`**
