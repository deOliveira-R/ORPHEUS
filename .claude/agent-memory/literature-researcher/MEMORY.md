...
- [dsa_primaries_full_extraction.md](dsa_primaries_full_extraction.md) — **#2 DSA memo DONE** → `.claude/plans/dsa_literature_memo.md`: all 5 primaries verified; Alcouffe (17)/(23) PRINT sign slips resolved (+ Eq.16 ⅓ OCR trap); Larsen-I four-step (16)→(18)→(27)/(28) + BC rows + K_N table; McCoy-Larsen Table II partial-consistency control; Morel albedo rows + curvilinear no-proof; Σw=1 vs A&L Σw=2; absent: Adams-Martin'92/WWM'04/Yavuz-Larsen'88.
