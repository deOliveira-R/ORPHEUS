...
- [adjoint_bilinear_collapse_p6.md](adjoint_bilinear_collapse_p6.md) — P6 #281: LOCAL corpus = Hébert Ch3 (adjoint objects, φ*_g=lethargy-AVG (3.118), Rayleigh (3.63) point-wise + stationarity p.77) + Dorning Century-ch8 (ρ/β̄/Λ̄ bilinear (8.44)-(8.46); §8.5.4 fwd×adj homogenization from asymptotics) + Roy ch4 (flux-wt+μ/GET, adjoint=response only); per-channel collapse formulas NOT local → B&G Ch6/Stacey Ch13/Williams-CRC acquisition list; memo `.claude/plans/p6_literature_memo.md`.
