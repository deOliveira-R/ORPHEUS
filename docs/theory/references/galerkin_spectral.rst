...
.. note:: TODO — Archivist expansion needed.
   ...
   :func:`tests.gates.derivations.test_carlvik_galerkin_symbolic.test_v_cg_1_galerkin_lhs_identity`.
...
.. note:: TODO — Archivist expansion needed.
   ...
   :func:`tests.gates.derivations.test_carlvik_galerkin_symbolic.test_v_cg_2_eq3_matrix_eigenvalue_form`.
...
.. note:: TODO — Archivist expansion needed.
   ...
   :func:`tests.gates.derivations.test_carlvik_galerkin_symbolic.test_v_cg_3_A_00_closed_form_slab`.
...
.. note:: TODO — Archivist expansion needed.
   ...
   :func:`tests.gates.derivations.test_carlvik_galerkin_symbolic.test_v_cg_4_basis_parity_slab_vs_sphere`.
...
.. note:: TODO — Archivist expansion needed.
   ...
   :func:`tests.gates.derivations.test_carlvik_galerkin_symbolic.test_v_cg_5_B_mn_boundary_chord_rank_one`.
...
.. note:: TODO — Archivist expansion needed.
   ...
   :func:`tests.gates.derivations.test_carlvik_galerkin_symbolic.test_v_cg_6_eq4_block_linearization`.
...
.. note:: TODO — Archivist expansion needed.
   ...
   :func:`tests.gates.derivations.test_carlvik_galerkin_symbolic.test_v_cg_7_carlvik_eq4b_correction_documented`.
...
.. note:: TODO — Archivist expansion needed.
   ...
   :func:`tests.gates.derivations.test_carlvik_galerkin_symbolic.test_v_cg_8_isotropic_limit`.
