...
architecture map, the transport equation, the shared cell-update and
dispatch contracts, and the not-yet-chaptered sections
(InvertibleOperator, SNSolver, consuming-the-frame); the chapter
decomposition is tracked as issue
