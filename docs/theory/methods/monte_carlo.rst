...
.. note::
   ...
   **ERR-024** in ``docs/theory/verification/error_catalog.rst`` and closed by issue
...
The verification evidence for the MC solver — the analytical
homogeneous eigenvalues, the CP-referenced heterogeneous pin-cell
cases, the 55-test four-level suite, and the failure-mode coverage
map — lives in the verification part:
:doc:`/theory/verification/monte_carlo`.  The auto-generated
