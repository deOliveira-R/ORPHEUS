..
   AUTO-GENERATED by ``tools/verification/generate_peierls_nystrom_matrix.py``.
...
.. list-table:: Shipped Nyström-discretised Peierls continuous references (operator_form ``integral-peierls``)
   :header-rows: 1
