...
- **MEMBERS SPELLED WITHOUT THE SYMBOL** are enumerated by the `retirement-audit` skill's census (seventeen spellings, each found by a red loop or by reading), never by a symbol grep.
