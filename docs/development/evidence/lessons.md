...
Verbatim bodies of every lesson in the main-agent lessons file (L1 through L64), moved here 2026-09-20. The one-line index, which is the source of the generated `.claude/lessons.md`, is [lessons.md](../lessons.md). A lesson with no index line is one whose mechanism a rule or skill clause now states; its first line below names that clause.

## L1 nexus grep choice

Absorbed into nexus-tools (the routing table) — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
Absorbed into vv-principles NEVER-3 — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L3 read theory first

Absorbed into Cardinal Rule 3 (read the theory page before modifying a solver) — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L4 never transcribe values

Absorbed into CLAUDE.md Code style (never transcribe values manually) — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L5 pythonic not matlab

Absorbed into CLAUDE.md Code style (Pythonic, no 1:1 MATLAB copy) — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L6 self scatter iteration

Physics fact; its durable home is the theory page — index line retired 2026-09-20.
...
## L11 structural independence

Absorbed into vv-principles NEVER-7 and NEVER-2 — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L12 fabricated closeout numbers
...
## L16 hidden performance regression
...
## L17 convention crosswalk first

Absorbed into coding-elegance Pattern 7 — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L20 retirement dependency audit

Absorbed into coding-standards (the three-search retirement audit) — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L27 per ordinate audit

Absorbed into vv-principles NEVER-8 — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
Absorbed into process-discipline (never git checkout to revert a mutation) — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L31 verdict versus attribution
...
## L34 path segments grep

Absorbed into coding-standards (the last-segment path clause) — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L45 symmetry annihilates diagnostic
...
## L47 fixture structurally blind
...
## L49 reference limited instrument
...
## L50 uncommitted parallel output
...
## L53 stale inventory denominator
...
Absorbed into plan-authoring section 2 (the FILTER/VIEWPORT clause) — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L58 promise not gated

Absorbed into vv-principles NEVER-26 — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
...
## L61 unvalidated filter clean

Absorbed into nexus-tools (the ugrep clause) and plan-authoring section 2 (the FILTER clause) — index line retired 2026-09-20 (ruling: the rule stays, the lesson goes).
