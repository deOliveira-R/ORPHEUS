...
hand-rolled: [the conceptual view](docs/architecture/conceptual_view.rst).
...
[the theory index](docs/theory/index.rst): conventions first, then the
...
costs: [the harness page](docs/development/harness.md).
